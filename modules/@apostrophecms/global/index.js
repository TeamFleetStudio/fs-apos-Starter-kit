  ...
  fields: {
    add: {
      ...
      h1FontSize: {
        type: 'string',
        label: 'H1 Font Size',
        help: 'Font size for Heading 1 (e.g., 58px, 3.625rem)',
        def: '58px'
      },
      h1LineHeight: {
        type: 'string',
        label: 'H1 Line Height',
        help: 'Line height for Heading 1 (e.g., 60px, 1.2)',
        def: '60px'
      },
      h2FontSize: {
        type: 'string',
        label: 'H2 Font Size',
        help: 'Font size for Heading 2 (e.g., 40px, 2.5rem)',
        def: '40px'
      },
      h2LineHeight: {
        type: 'string',
        label: 'H2 Line Height',
        help: 'Line height for Heading 2 (e.g., 46px, 1.15)',
        def: '46px'
      },
      h3FontSize: {
        type: 'string',
        label: 'H3 Font Size',
        help: 'Font size for Heading 3 (e.g., 36px, 2.25rem)',
        def: '36px'
      },
      h3LineHeight: {
        type: 'string',
        label: 'H3 Line Height',
        help: 'Line height for Heading 3 (e.g., 36px, 1)',
        def: '36px'
      },
      h4FontSize: {
        type: 'string',
        label: 'H4 Font Size',
        help: 'Font size for Heading 4 (e.g., 30px, 1.875rem)',
        def: '30px'
      },
      h4LineHeight: {
        type: 'string',
        label: 'H4 Line Height',
        help: 'Line height for Heading 4 (e.g., 32px, 1.07)',
        def: '32px'
      },
      h5FontSize: {
        type: 'string',
        label: 'H5 Font Size',
        help: 'Font size for Heading 5 (e.g., 26px, 1.625rem)',
        def: '26px'
      },
      h5LineHeight: {
        type: 'string',
        label: 'H5 Line Height',
        help: 'Line height for Heading 5 (e.g., 28px, 1.08)',
        def: '28px'
      },
      h6FontSize: {
        type: 'string',
        label: 'H6 Font Size',
        help: 'Font size for Heading 6 (e.g., 24px, 1.5rem)',
        def: '24px'
      },
      h6LineHeight: {
        type: 'string',
        label: 'H6 Line Height',
        help: 'Line height for Heading 6 (e.g., 24px, 1)',
        def: '24px'
      },
      pFontSize: {
        type: 'string',
        label: 'Paragraph Font Size',
        help: 'Font size for default paragraph text (e.g., 22px, 1.375rem)',
        def: '22px'
      },
      pLineHeight: {
        type: 'string',
        label: 'Paragraph Line Height',
        help: 'Line height for default paragraph text (e.g., 32px, 1.45)',
        def: '32px'
      },
      p1FontSize: {
        type: 'string',
        label: 'P1 (Small Heading) Font Size',
        help: 'Font size for P1 / small heading text (e.g., 20px)',
        def: '20px'
      },
      p1LineHeight: {
        type: 'string',
        label: 'P1 (Small Heading) Line Height',
        help: 'Line height for P1 / small heading text (e.g., 28px)',
        def: '28px'
      },
      p2FontSize: {
        type: 'string',
        label: 'P2 (Small Paragraph) Font Size',
        help: 'Font size for P2 / small paragraph text (e.g., 18px)',
        def: '18px'
      },
      p2LineHeight: {
        type: 'string',
        label: 'P2 (Small Paragraph) Line Height',
        help: 'Line height for P2 / small paragraph text (e.g., 26px)',
        def: '26px'
      },
      p3FontSize: {
        type: 'string',
        label: 'P3 (Extra Small Paragraph) Font Size',
        help: 'Font size for P3 / extra small paragraph text (e.g., 16px)',
        def: '16px'
      },
      p3LineHeight: {
        type: 'string',
        label: 'P3 (Extra Small Paragraph) Line Height',
        help: 'Line height for P3 / extra small paragraph text (e.g., 24px)',
        def: '24px'
      },
      hrColor: {
        type: 'color',
        label: 'Horizontal Rule Color',
        help: 'Color of the <hr> horizontal rule in rich text (default: #000000)',
        def: '#000000'
      },
      hrHeight: {
        type: 'string',
        label: 'Horizontal Rule Thickness',
        help: 'Thickness of the horizontal rule (e.g., 1px, 2px)',
        def: '1px'
      }
    },
    group: {
      ...
      typographyHeadings: {
        ...
        fields: [
          'h1FontSize', 'h1LineHeight',
          'h2FontSize', 'h2LineHeight',
          'h3FontSize', 'h3LineHeight',
          'h4FontSize', 'h4LineHeight',
          'h5FontSize', 'h5LineHeight',
          'h6FontSize', 'h6LineHeight'
        ]
      },
      typographyBody: {
        label: 'Typography - Body',
        fields: [
          'pFontSize', 'pLineHeight',
          'p1FontSize', 'p1LineHeight',
          'p2FontSize', 'p2LineHeight',
          'p3FontSize', 'p3LineHeight',
          'hrColor', 'hrHeight'
        ]
      },
      header: {
